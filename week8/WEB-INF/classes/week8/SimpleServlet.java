...
@WebServlet(name="SimpleServlet", 
			...
			initParams = {@WebInitParam(name="ctxname",value="week8")}
)

public class SimpleServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
	private String annotatedCtxName=null;
	//private String webContextName = null;
	

	@Override
	public void init() throws ServletException {
		annotatedCtxName=getInitParameter("ctxname");
		System.out.println("Annotated Context Name :"+annotatedCtxName);
...
//	
	...
	private void printData(HttpServletRequest req, HttpServletResponse resp) throws IOException {
		if (null != req) {
			...
			mout.println("Annotated Context name " +annotatedCtxName);
